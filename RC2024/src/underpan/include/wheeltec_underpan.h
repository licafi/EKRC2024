...
class turn_on_robot
{
	...
	private:
		...
		ros::Publisher odom_publisher, imu_publisher, voltage_publisher,distance_publisher,Charging_publisher, Charging_current_publisher, RED_publisher; //Initialize the topic publisher //初始化话题发布者
