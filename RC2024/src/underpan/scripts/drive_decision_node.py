...
def side_flag_callback(msg):
	...
	for boxes in msg.bounding_boxes:
		if boxes.Class == "turn" and boxes.probability > 0.6:
			if boxes.xmax < 320 and boxes.ymax > 200 and boxes.xmax > 30:
				side_flag = 1
			elif boxes.xmin > 320 and boxes.ymax > 200 and boxes.xmin < 610:
				side_flag = 2
		elif boxes.Class == "road_construction" and boxes.probability > 0.6:
			if boxes.ymax > 450 and boxes.xmin < 400 and boxes.xmax > 250 :
				road_construction_flag = 1
		elif boxes.Class == "crossing" and boxes.probability > 0.4:
			if 380 < boxes.ymin < 450:
				crossing_flag = 1
		elif boxes.Class == "bus" and boxes.probability > 0.6:
