...
{
  turn_on_wheeltec_robot::supersonic distance_msg;
...
turn_on_robot::turn_on_robot():Sampling_Time(0),Power_voltage(0)
{
  ...
  private_nh.param<std::string>("usart_port_name",  usart_port_name,  "/dev/wheeltec_wheeltec"); //Fixed serial port number //固定串口号
  ...
  distance_publisher= n.advertise<turn_on_wheeltec_robot::supersonic>("Distance", 10); //创建超声波距离话题发布者
