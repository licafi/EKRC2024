...
//#include "turn_on_wheeltec_underpan/supersonic.h"  //dir:RC2024/devel/include/turn_on_wheeltec_underpan
using namespace std;
...
class turn_on_underpan
{
	public:
		...
		bool odomClearFlag = 0; //Clear the odometer flag //清除里程计标志位
